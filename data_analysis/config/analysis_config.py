...
class Analysis_Config:
    ...
    def __init__(self):
        ...
        __class__.PICKLE_PATH = os.path.join(Analysis_Config.WORK_DIR, 'pickle_files')
        __class__.DATA_ANALYSIS_OUTPUTS_PATH = os.path.join(Analysis_Config.WORK_DIR, 'data_analysis_outputs')
    ...
    def load_yaml(file_name):
        with open(os.path.join(Analysis_Config.YAML_FILE_PATH, f'{file_name}.yaml'), 'r') as data:
